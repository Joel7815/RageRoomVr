...
import { InteractableCube } from './objects/Interactable.js';
...
export class FirstPersonCameraDemo {
    ...
    // Add the interactable cube to the scene and physics world
      const cube = new InteractableCube(1, new THREE.Vector3(5, 1, 5));
      this.scene_.add(cube.mesh);
      this.physicsWorld.addBody(cube.body);
    }
    ...
    initializeScene_() {
      ...
      this.objects_ = [plane, box, wall1, wall2, wall3, wall4];
